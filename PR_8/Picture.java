...
class Picture extends JFrame {
    ...
    String animation_images_path = "C:/Users/Users/Puker/Desktop/2/ява/frame/кот 1.png";
    int method;
    ...
    public static void main(String[] args) {
        ...
        if (args.length == 1) {
            ...
            Picture.set_background_image_path(args[0]);
            Picture.set_animation_images_path(args[1]);
        }
        else {
            System.out.println("[!] Background image path is empty");
        }
        /* C:\Users\Puker\Desktop\2\ява\frame */
    }
}